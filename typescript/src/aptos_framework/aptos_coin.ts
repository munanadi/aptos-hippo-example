...
export function initialize_ (
  ...
  System_addresses.assert_aptos_framework_(aptos_framework, $c);
  [burn_cap, freeze_cap, mint_cap] = Coin.initialize_with_parallelizable_supply_(aptos_framework, Std.String.utf8_([u8("65"), u8("112"), u8("116"), u8("111"), u8("115"), u8("32"), u8("67"), u8("111"), u8("105"), u8("110")], $c), Std.String.utf8_([u8("65"), u8("80"), u8("84")], $c), u8("8"), false, $c, [new SimpleStructTag(AptosCoin)]);
